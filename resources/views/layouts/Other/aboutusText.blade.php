        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-misson">
                    <h3>Perché Lo<span> Facciamo?</span></h3>
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-misson">
                    <h3>La Nostra<span>Missione</span></h3>
                    <p>Huis nostrud exerci tation ullamcorper suscipites lobortis nisl ut aliquip ex ea commodo consequat. Investigationes demonstraverunt lectores legere me lius quod ii legunt saepius claritas.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-misson mrg-none-xs">
                    <h3>La Nostra<span>Visione</span></h3>
...
<div class="team-area pt-70 pb-40">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12" style="margin-right: 140px;">
                <div class="single-team mb-30">
                    <div class="team-img-area">
                        <div class="team-img">
                            <a href="https://github.com/DanieleF198"><img src="img/team/1.jpg" alt="man" /></a>
                        </div>
                        <div class="team-link">
                            <ul>
                                <li><a href="https://github.com/DanieleF198"><i class="fa fa-github"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="team-content text-center">
                        <h3>Daniele Fossemò</h3>
                        <span>Coder</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12" style="margin-right: 140px;">
                <div class="single-team mb-30">
                    <div class="team-img-area">
                        <div class="team-img">
                            <a href="https://github.com/Cronio"><img src="img/team/2.jpg" alt="man" /></a>
                        </div>
                        <div class="team-link">
                            <ul>
                                <li><a href="https://github.com/Cronio"><i class="fa fa-github"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="team-content text-center">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="single-team mb-30">
                    <div class="team-img-area">
                        <div class="team-img">
                            <a href="https://github.com/GianlucaRea"><img src="img/team/3.jpg" alt="man" /></a>
                        </div>
                        <div class="team-link">
                            <ul>
                                <li><a href="https://github.com/GianlucaRea"><i class="fa fa-github"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="team-content text-center">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="skill-content">
                    <h3>Perché scegliere <span>DGDComics</span></h3>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="skill-progress">
                    <div class="progress">
                        <div class="skill-title">Strategia 75%</div>
                        <div class="progress-bar wow fadeInLeft" data-wow-delay="0.2s" role="progressbar" style="width: 75%;">
                        </div>
                    </div>
                    <div class="progress">
                    ...
                    <div class="progress">
                        <div class="skill-title">Complicità 65%</div>
                        <div class="progress-bar wow fadeInLeft" data-wow-delay="0.4s" role="progressbar" style="width: 75%;">
                        </div>
                    </div>
                    <div class="progress mrg-none-xs">
                        <div class="skill-title">Fumetti 92%</div>
