            ...
            <div class="billing-fields">
                <form method="POST" action="{{ route('modifyComic', ['comic_id' => $comic->id]) }}" enctype="multipart/form-data">
                   ...
                   {{-- @php($numImmagine = 1)
                    ...
                    {{--@for($numImmagine; $numImmagine < 5; $numImmagine++)
                            @if($numImmagine == 1)
                                <div class="row">
                                    <div class="col-lg-2.5">
                                        <div class="single-input-item">
                            ...
                            <div class="row">
                                <div class="col-lg-2.5">
                                    <div class="single-input-item">
                                        <label for="file" class="required">Immagine {{ $numImmagine }}<span>*</span></label>
                                        <br>
                                        <img src="{{asset('img/comicsImages/' . $images->image_name) }}" style=" background-repeat: no-repeat; background-size: contain; width: 180px; height: 270px;"/>
                                    </div>
                                </div>
                                <div class="col-lg-3.5">
                                    <div class="single-input-item">
