...
class CreateCommentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('comments')->insert([
            ...
            ['user_id' => '8', 'article_id' => '1', 'answer' => 'One piece è molto sopravalutato', 'parent_comment' => '0'],
            ['user_id' => '6', 'article_id' => '1', 'answer' => 'Bhè un opinione non comune visto che è il più venduto al mondo!!!', 'parent_comment' => '6'],
        ]);
    }
